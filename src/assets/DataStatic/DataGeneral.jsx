...
export const General = [
    ...
    },
    {
        ...
        preco: 40.00,
        resumo: 'O livro infanto-juvenil de George R.R.Martin! O dragão de gelo era uma criatura lendária e temida, pois nenhum homem jamais havia domado um. Quando sobrevoava o mundo, deixava um rastro de frio desolador e terras congeladas. Mas Adara não tinha medo, pois ela era uma criança do inverno, nascida durante o frio mais intenso de que alguém tinha memória. Adara não se lembrava de quando viu o dragão de gelo pela primeira vez. Parecia que a criatura sempre estivera em sua vida.',
        imagem: img.LA07
    }
];
